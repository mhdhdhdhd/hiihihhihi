...
client.on("guildMemberAdd", member => {
  ...
  member.guild.fetchInvites().then(guildInvites => {
    ...
    setTimeout(() => {
      logChannel.send(`**#・Welcome To server ${member.guild.name} 
#・Uesr : ${member}
...
client.on('guildMemberAdd', member=> {
    member.addRole(member.guild.roles.find("name"," ═‏═══ஜLEVELSஜ═════ "));
    });

client.on('guildMemberAdd', member=> {
    member.addRole(member.guild.roles.find("name","══‏═══ஜgamesஜ════"));
    });

client.on('guildMemberAdd', member=> {
    member.addRole(member.guild.roles.find("name","══‏═══ஜinfoஜ═════"));
    });

client.on('guildMemberAdd', member=> {
    member.addRole(member.guild.roles.find("name","‏═════ஜادارهஜ═════"));
    });

client.on('guildMemberAdd', member=> {
    member.addRole(member.guild.roles.find("name","あ - Members"));
    });
